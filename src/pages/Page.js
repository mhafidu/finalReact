...
function page() {
    ...
    // }
    // navLink.forEach(n => n.addEventListener('onClick', linkAction))
    ...
    return (
        ...
        <main className="l-main">
            ...
            <section className="home" id="home">
                <div className="home__container bd-container bd-grid">
                    <div className="home__data">
                        <h1 className="home__title">Start Small, Think Big DO IT NOW !</h1>
            ...
            <section className="about section bd-container" id="about">
                <div className="about__container  bd-grid">
                    <div className="about__data">
                        ...
                        <h2 className="section-title about__initial">Menghubungkan user dengan perusahaan</h2>
            ...
            <section className="menu section bd-container" id="menu">
                ...
                <h2 className="section-title">Menu Magangs</h2>

                <div className="menu__container bd-grid">
                    <div className="menu__content">
                        <img src="https://source.unsplash.com/random/100x100" alt="" className="menu__img"/>
